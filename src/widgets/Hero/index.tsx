...
const GlobeHero = () => {
  return (
    ...
    >
      {/* =====================================================
          AMBIENT BACKGROUND
          No solid bg-black so ShadowCursor remains visible
      ===================================================== */}
      <div
        className="
          pointer-events-none
      ...
      {/* =====================================================
          BOTTOM FADE
          Transparent enough to keep cursor/background visible
      ===================================================== */}
      <div
        className="
          pointer-events-none
  ...
  return (
    ...
    >
      {/* =====================================================
          ...
          IMPORTANT:
          No bg-[#020303] here.
          This allows the global ShadowCursor to remain visible.
      ===================================================== */}
      <div
        className="
          pointer-events-none
      ...
      >
        ...
        <div
          className="
            absolute
            inset-0
            bg-[radial-gradient(circle_at_50%_72%,rgba(36,182,180,.065),transparent_30%),radial-gradient(circle_at_50%_46%,rgba(255,255,255,.025),transparent_43%)]
          "
        />
        ...
        <div
          className="
            ...
            h-[55%]
            opacity-[0.16]
            [background-image:radial-gradient(rgba(111,224,226,.7)_0.7px,transparent_0.7px)]
            [background-size:8px_8px]
            [mask-image:radial-gradient(ellipse_at_top,black,transparent_74%)]
          "
        />
      ...
      >
        ...
        <motion.p
          ...
          "
        >
          We help businesses innovate, transform, and scale digitally through
          modern technology, intelligent strategy, and inspiring experiences.
        </motion.p>
        ...
        >
          ...
          <Link
            ...
            className="
              ...
              duration-300
              hover:bg-orange-300
              hover:shadow-[0_0_35px_rgba(251,146,60,.22)]
            "
          >
            Start a project
  ...
  >
    ...
    >
      ...
      >
        ...
        {/* Curved Paths */}
        <path
          d="M70 500C330 370 512 185 743 197C985 210 1110 410 1360 466"
          stroke="url(#orbit)"
          strokeWidth="0.8"
        />

        <path
          d="M-40 610C310 505 565 505 1440 485"
          stroke="url(#orbit)"
          strokeWidth="0.65"
        />
      </svg>
...
const OrbitNode = ({
  ...
  <motion.span
    className={`
      ...
      rounded-full
      bg-[#75e5e7]
      shadow-[0_0_18px_rgba(117,229,231,.55)]
      ${className}
      ${size}
    `}
    animate={
