        ...
        >
          <div>
            ...
            <h2
              className="
                max-w-4xl
                text-[clamp(3.35rem,8vw,7.75rem)]
                font-semibold
                leading-[0.82]
                tracking-[-0.065em]
              "
          ...
          <p
            ...
            "
          >
            Strategy, design, and technology—brought together to build digital
            products people remember and businesses rely on.
          </p>
        </motion.div>
    ...
    >
      ...
      <span
        className="
          ...
          transition-colors
          duration-500
          group-hover:text-orange-400/[0.055]
          md:text-[12rem]
        "
      >
        {card.number}
